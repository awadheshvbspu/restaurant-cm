...
export default function Team() {
  const {pretitle,title,signatureImg,sub1,sub2,occupation,name,chefImg} =teamData
  return (
    <section className='relative top-96 z-10 lg:top-[480px] min-h-[720px]'>
    <div className='container mx-auto'>
    <div className='flex flex-col lg:flex-row lg:gapx-[120px] items-center lg:items-start'>
    <motion.div 
    ...
    initial='hidden'
    whileInView={'show'}
    className='flex-1'><img src={chefImg} alt=''/>
    </motion.div>
    </div>
    </div>
