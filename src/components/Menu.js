...
export default function Menu() {
  ...
  return (
    <section className='min-h-[780px]'>
      ...
      <motion.div variants={staggerContainer}  initial='hidden' whileInView={'show'} viewport={{once:false, amount: 0.1}} className='relative z-10 top-72 lg:top-52'>
                ...
                return (
                  <div key={i}>
                    <div className='flex flex-row lg:flex-col h-full'>
                      ...
                      <div className='bg-[#fff3e4] flex-1 flex flex-col justify-center px-4 lg:p-12 lg:max-h-[250px] xl:max-h-max'>
